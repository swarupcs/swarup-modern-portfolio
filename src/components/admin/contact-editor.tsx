    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your contact information is managed in the Personal Info tab. Go there to update your email, phone, and
            social links.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">{portfolioData.personalInfo.location}</p>
            </div>
          </div>
        </CardContent>
      </Card>
