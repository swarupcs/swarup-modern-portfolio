...
const educationData = [
  {
    ...
    courses: ["Advanced Algorithms", "Machine Learning", "Neural Networks", "Data Visualization"],
  },
  {
    id: 2,
    ...
    achievements: ["GPA: 3.7/4.0", "Scholarship Recipient", "Programming Club President"],
    courses: ["Data Structures", "Operating Systems", "Web Development", "Database Systems"],
  },
  {
    id: 3,
  ...
  return (
    <section id="education" className="py-16 md:py-24 bg-muted/50">
      <div className="container px-4 md:px-6">
        <SectionHeading title="Education" description="My academic background and qualifications" />
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-start md:gap-8 pb-10">
                <div className="mb-4 hidden md:block md:w-1/2 md:text-right md:pr-8 pt-1">
                  <span className="text-sm font-medium text-muted-foreground">{education.duration}</span>
                </div>
                      ...
                      <CardHeader>
                        <div className="space-y-1">
                          ...
                          <CardDescription className="flex flex-col gap-1">
                            ...
                            <span className="md:hidden">{education.duration}</span>
                          </CardDescription>
                        </div>
                      </CardHeader>
                      <CardContent>
                        <p className="mb-4 text-sm text-muted-foreground">{education.description}</p>
